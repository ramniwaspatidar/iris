...
@interface LipidViewController : UIViewController<UITextFieldDelegate>
{
    ...
    __weak IBOutlet UILabel *liquidLbl;
    
}
@property (nonatomic,strong)NSDictionary *personDetailDictionary;@end
