...
// Use this on iOS7 when you add an instance of RevealViewController as a child of a UINavigationController (or another RevealViewController)
...
// Delegate
@property (weak, nonatomic) id<RevealViewControllerDelegate> delegate;
...
- (void)revealController:(RevealViewController *)revealController willMoveToPosition:(FrontViewPosition)position;
- (void)revealController:(RevealViewController *)revealController didMoveToPosition:(FrontViewPosition)position;

// This will be called inside the reveal animation, thus you can use it to place your own code that will be animated in sync
- (void)revealController:(RevealViewController *)revealController animateToPosition:(FrontViewPosition)position;

// Implement this to return NO when you want the pan gesture recognizer to be ignored
- (BOOL)revealControllerPanGestureShouldBegin:(RevealViewController *)revealController;
...
- (void)revealControllerPanGestureBegan:(RevealViewController *)revealController;
- (void)revealControllerPanGestureEnded:(RevealViewController *)revealController;
...
- (void)revealController:(RevealViewController *)revealController panGestureBeganFromLocation:(CGFloat)location progress:(CGFloat)progress;
- (void)revealController:(RevealViewController *)revealController panGestureMovedToLocation:(CGFloat)location progress:(CGFloat)progress;
- (void)revealController:(RevealViewController *)revealController panGestureEndedToLocation:(CGFloat)location progress:(CGFloat)progress;
...
// We add a category of UIViewController to let childViewControllers easily access their parent RevealViewController
...
#pragma mark - RevealViewControllerSegue

@interface RevealViewControllerSegue : UIStoryboardSegue

@property (strong) void(^performBlock)( RevealViewControllerSegue* segue, UIViewController* svc, UIViewController* dvc );
@end
