...
{   
    ...
    if ([MainSideMenuViewController isCurrentLanguageEnglish]){
        ...
        [_formatter  setLocale:[NSLocale localeWithLocaleIdentifier:@"en"]];
        _locale = [NSLocale localeWithLocaleIdentifier:@"en"];
        _components.calendar.locale = [NSLocale localeWithLocaleIdentifier:@"en"];
        ...
        [_formatter  setLocale:[NSLocale localeWithLocaleIdentifier:@"ar"]];
        
        _locale = [NSLocale localeWithLocaleIdentifier:@"ar"];
        _components.calendar.locale = [NSLocale localeWithLocaleIdentifier:@"ar"];
...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([MainSideMenuViewController isCurrentLanguageEnglish]){
            ...
            cell.titleLabel.text =  [Localization languageSelectedStringForKey:[self.dataSourceProxy calendar:self titleForDate:date] ?: @([self.gregorian component:NSCalendarUnitDay fromDate:date]).stringValue];
